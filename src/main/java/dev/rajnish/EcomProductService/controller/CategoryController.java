...
public class CategoryController {
    ...
    public ResponseEntity createNewCategory(@RequestBody CreateCategoryRequestDTO createCategoryRequestDTO,@RequestHeader(HttpHeaders.AUTHORIZATION) String token)
    {
        CategoryResponseDTO categoryResponseDTO = categoryService.createNewCategory(createCategoryRequestDTO,token);
